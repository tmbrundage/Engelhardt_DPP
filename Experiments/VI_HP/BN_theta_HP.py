        ...
        for name,value in kwargs.items():
            if name == 'prior':
                if value == 'uniform':
                    ...
                    self.logThetaPrior = lambda state: theat_priors.laplaceLogLikelihood(state)
                    self.gradLogThetaPrior = lambda state: theta_priors.gradLaplaceLogLikelihood(state)
