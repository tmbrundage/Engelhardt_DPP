...
ns = [50,100,200,400]#[50,100,150,200,400,800,1600]#[10,20,50,100,200,500,1000,2000,5000]
n_test = 1000
p=40
sparsity=0.90
...
for rep in range(repeat):
    for n in ns:
        ...
        DPP_PO = PO.PO(X,y,max_T = 500, GA_max_T = 200)
        ...
        print "DPP_PO MSE: %f    BETA_LOSS: %f   OPT_LAM: %f    TOTAL:%d" % (DPP_PO_mse, DPP_PO_betaLoss, DPP_PO.c, sum(DPP_PO.gamma))
